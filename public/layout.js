...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    return {
      ...
      items: [{
        ...
        children: [{
          ...
          text: 'Tipos de carnet',
          href: "license_type"
        }, {
          icon: 'mdi-account-cash-outline',
          text: 'Tipos de salario',
          href: "salary_type"
        }, {
          icon: 'mdi-bank',
          text: 'Bancos',
          ...
          icon: 'mdi-bank',
          text: 'Historico de salario',
          href: "salary_history"
        }, {
          icon: 'mdi-bank',
          text: 'Historico de modulo acreedores',
          href: "creditor_history"
  ...
  mounted: function mounted() {
    ...
    this.permission = JSON.parse("[ ".concat(localStorage.getItem("permission_id"), " ]"));
  },
  computed: {
    Drawer: {
      get: function get() {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "v-app-bar",
        { staticClass: "border", attrs: { color: "primary", dark: "" } },
        [
          ...
          _vm._v(" "),
          _c("v-toolbar-title", [_vm._v("RRHH")]),
          _vm._v(" "),
          _c("v-spacer"),
          _vm._v(" "),
          _c(
