                    ...
                    <v-data-table
                        ...
                        <template v-slot:top>
                            <v-toolbar flat color="transparent" class="round">
                                <v-toolbar-title>Historico de Salario</v-toolbar-title>
                                <v-divider
                                    class="mx-4"
                                    inset
                                    vertical></v-divider>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            ItemsSalary() {
                return this.$store.getters["employee/GET_HISTORY_SALARY"];
            },
        },
        ...
        methods: {
            async initialize() {
                try {
                    ...
                    const response = await this.$store.dispatch("employee/INDEX_HISTORY_SALARY", request);
                } catch (error) {
                    console.log(error);
                }
            }
