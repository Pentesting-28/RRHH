                    ...
                    <ValidationObserver tag="form" v-slot="{ passes }" ref="obs">
                        <v-row>
                            ...
                            <v-col cols="12" sm="12" md="4">
                             ...
                             <!-- <v-col cols="12" sm="12" md="4">
                                <ValidationProvider name="license_types_id" rules="required" v-slot="{ errors }">
                                    <v-autocomplete
                                      multiple
                                      v-model="editedItem.license_letter_id"
                            ...
                            <v-col cols="12" sm="12" md="6">
                                    <ValidationProvider name="license_path" v-slot="{ errors }">
                                        <v-file-input
                                          outlined
                                          dense
                                          show-size
    ...
    export default {
        ...
        methods: {
            ...
            async save() {
                ...
                formData.append("license_types_id", this.editedItem.license_types_id);
                ...
                if (this.edit === true) {
                    ...
                    try {
                        const response = await this.$store.dispatch("driving_license/UPDATED", request);
                    ...
                    try {
                        ...
                        const response = await this.$store.dispatch("driving_license/REGISTER", request);
