...
<script>
  ...
  import dialogDepartment from './Dialog';
  ...
  export default {
    ...
    methods: {
      async initialize () {
        try {
          const response = await this.$store.dispatch("department/INDEX_DEPARTMENT");
        } catch (error) {
          console.log(error);
        }
      },
      ...
      editItem (item) {
        this.data_edit = {
          ...item,
          position_array: this.ItemsDepartment.indexOf(item)
        }
      ...
      async deleteItem (item) {
        try {
          ...
          console.log(request,'*******')
          const response = await this.$store.dispatch("department/DELETE", request);
        } catch (error) {
          console.log(error);
        }
