        ...
        methods: {
            ...
            async save() {
                ...
                if (this.edit === true) {
                    ...
                    try {
                        const response = await this.$store.dispatch("type_expense/UPDATED", request);
                        ...
                        let e = error.response.data?.message ? error.response.data.message : error.response.data.error;
                    ...
                    try {
                        ...
                        const response = await this.$store.dispatch("type_expense/REGISTER", request);
