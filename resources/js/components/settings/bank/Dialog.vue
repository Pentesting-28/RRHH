...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle() {
                return this.edit === false ? 'Nuevo Banco' : 'Editar Banco'
            },
            // status: {
            //     get () {
        ...
        methods: {
            ...
            async save() {
                ...
                if (this.edit === true) {
                    ...
                    try {
                        const response = await this.$store.dispatch("bank/UPDATED", request);
                    ...
                    try {
                        ...
                        const response = await this.$store.dispatch("bank/REGISTER", request);
